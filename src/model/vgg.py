...
defaultcfg = {
    ...
    17: [128, 128, 'M', 256, 256, 'M', 256, 256, 256, 'M', 512, 512, 512, 'M', 512, 512, 512],
...
class VGG(nn.Module):
    def __init__(self, dataset='cifar10', depth=19, init_weights=True, cfg=None, affine=True, batchnorm=True):
        ...
        self.feature = self.make_layers(cfg, batchnorm, input_ch)
    ...
    def make_layers(self, cfg, batch_norm=False, input_ch=3):
        layers = []
